...
function LeftoverOptionsPage({
  ...
  return (
    <div className="page-fade" style={{ maxWidth: 1120, margin: "0 auto", position: "relative" }}>
      ...
      {/* ---- Two-column layout: Input grid + Visualizations ---- */}
      <div style={{ display: "flex", gap: 18, marginBottom: 18, flexWrap: "wrap" }}>
        {/* Left column: Compact input grid */}
        <div style={{ flex: "1 1 100%", minWidth: 0, overflowX: "auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: 14 }}>
            {/* Input Grid Card */}
            <div style={cardStyle}>
              <CornerBrackets size={10} color={ACCENT} />
              <div className="mono" style={{ fontSize: 10, letterSpacing: "0.1em", color: ACCENT, marginBottom: 12 }}>
                ▸ Quick input for all accounts
              </div>
              <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11 }}>
                  <thead>
                    <tr style={{ borderBottom: "1px solid rgba(51,214,255,0.2)" }}>
                      <th style={{ textAlign: "left", padding: "6px 0", color: "#6B7686", fontWeight: 600, fontSize: 10 }}>Account</th>
                      <th style={{ textAlign: "right", padding: "6px 6px", color: "#6B7686", fontWeight: 600, fontSize: 10 }}>Balance</th>
                      <th style={{ textAlign: "right", padding: "6px 6px", color: "#6B7686", fontWeight: 600, fontSize: 10 }}>Monthly</th>
                      <th style={{ textAlign: "right", padding: "6px 6px", color: "#6B7686", fontWeight: 600, fontSize: 10 }}>Target %</th>
                      <th style={{ textAlign: "center", padding: "6px 0", color: "#6B7686", fontWeight: 600, fontSize: 10 }}>Details</th>
                    </tr>
                  </thead>
                  <tbody>
                    {LEFTOVER_OPTIONS.map((opt) => {
                      ...
                      return (
                        <tr key={opt.name} style={{ borderBottom: "1px solid rgba(51,214,255,0.08)", background: expandedAccount === opt.name ? "rgba(51,214,255,0.08)" : "transparent" }}>
                          <td style={{ padding: "8px 0", color: opt.color, fontWeight: 500 }}>{opt.name}</td>
                          <td style={{ padding: "8px 6px", textAlign: "right" }}>
                            <input
                              type="number" min={0} max={ALLOC_MAX} step={100} value={balance}
                          ...
                          <td style={{ padding: "8px 6px", textAlign: "right" }}>
                            <input
                              type="number" min={0} max={CONTRIB_MAX} step={25} value={monthly}
                          ...
                          <td style={{ padding: "8px 0", textAlign: "center" }}>
                            <button
                              type="button"
                              onClick={() => setExpandedAccount(expandedAccount === opt.name ? null : opt.name)}
                              className="mono"
                              style={{
                                fontSize: 10,
                                padding: "4px 6px",
              ...
              <div style={{ fontSize: 9, color: "#3D4658", marginTop: 10 }}>Double-click cells to edit. Click details button to see projections and tax room info.</div>
            </div>
          </div>
        </div>

        {/* Expanded account details modal */}
        {expandedAccount && (
          <div style={{ flex: "1 1 100%", minWidth: 0 }}>
            {LEFTOVER_OPTIONS.map((opt) => {
              if (opt.name !== expandedAccount) return null;
